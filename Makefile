...
#	tests 
	...
	erlc -I include -o tests_ebin tests/*.erl;
#  	dependencies
#	rm -rf zigbee_devices;
#	git clone https://github.com/joq62/zigbee_devices.git;
#	cp zigbee_devices/ebin/* tests_ebin;
	rm -rf zigbee_devices;
	...
	rm -rf sd;
#	Applications
	erl -pa * -pa */ebin -pa ebin -pa tests_ebin -sname do_pid_test -run $(m) start $(cookie) $(parent) -setcookie test_cookie
